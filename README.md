### 改GuzzleHttp的curl模式为写成模式
vendor/hanson/foundation-sdk/src/Http.php
use Yurun\Util\Swoole\Guzzle\SwooleHandler; #yijie

$stack = HandlerStack::create(); 改成
$handler = new SwooleHandler(); #yijie
$stack = HandlerStack::create($handler); #yijie
