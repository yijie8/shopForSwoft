...
class indexController extends BaseController{
    /**
     * Get data list. access uri path: /admin
    ...
    /**
     * Get one by ID. access uri path: /admin/{id}
    ...
    /**
     * Create a new record. access uri path: /admin
    ...
    /**
     * Update one by ID. access uri path: /admin/{id}
    ...
    /**
     * Delete one by ID. access uri path: /admin/{id}
